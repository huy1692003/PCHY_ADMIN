...
const QuanLyBienBanQTTemChi = () => {
  ...
  const [bienBan, setBienBan] = useState(BienBanTemChi);
  const [bienBans, setBienBans] = useState([BienBanTemChi]);
        ...
        <div className="card">
          ...
          >
            <h3 className="card-title text-lg m-0">
              Quản lý Biên bản quyết toán tem chì
            </h3>
            <Button
              label="Thêm mới"
              icon="pi pi-plus"
          ...
          >
            ...
            <Column field="SO_LUONG_TRA" header="Số lượng trả"></Column>
            <Column field="SO_LUONG_THUHOI" header="Số lượng thu hồi"></Column>
...
export default QuanLyBienBanQTTemChi;
